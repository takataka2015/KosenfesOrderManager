...
//   return (
//     <div className="p-4">
//       <h2 className="font-bold text-lg mb-3">消込履歴</h2>
//       <div className="grid grid-cols-5">
//         {orders.length === 0 ? (
//           <div className="text-gray-500">消込履歴なし</div>
//         ) : (
//           orders.map((o) => (
//             <div
//               key={o.serial}
//               className="flex flex-col border rounded-sm p-3 mb-2 bg-white shadow-sm"
//             >
